...
\newcommand{\Dim}{\cellcolor{lsLightgray}}
...
\newcommand{\KTArr}[1]{%
  \raisebox{-4pt}{%
    \begin{tikzpicture}
      \node [inner sep=2] (name) at (0,0) {#1};
      \draw [fill=lightgray, draw=none] (name.north west) to (name.north east) to 
        ($(name.north east)!cos(45)!45:(name.south east)$) to
        (name.south east) to (name.south west) to (name.north west);
        \node [color=darkgray] (name2) at (0,0) {#1};
      \end{tikzpicture}%
    }%
  }
...
\newcommand{\onestar}{\colorbox{lsLightgray}{\textsc{routine}}}
\newcommand{\twostar}{\colorbox{lsLightgray}{\textsc{anspruch}}}
\newcommand{\tristar}{\colorbox{lsLightgray}{\textsc{transfer}}}
...
\newcommand{\tblsthickline}{{\color{lsLightGray}\rule{\textwidth}{1.2mm}}}
...
\newcommand{\Definition}[2]{
  ...
  \tblsframebox{lsLightGray}{#1\hfill Definition~\thechapter.\arabic{dgdef}}{#2}
}
...
\newcommand{\Satz}[2]{
  ...
  \tblsframebox{lsLightGray}{#1\hfill Satz~\thechapter.\arabic{dgsatz}}{#2}
}



\newcommand{\Zusammenfassung}[1]{
  \tblsframebox{lsLightGray}{Zusammenfassung von Abschnitt~\thesection}{#1}
}
...
\newcommand{\WFiltTree}[7][0mm]{%
  ...
  \tblsframebox{lsLightGray}{#2\hfill Wortklassenfilter~\arabic{deskgram-wfilt}}{
    \label{#3}
...
\newcommand{\Phrasenschema}[2]{
  ...
  \tblsframebox{lsLightGray}{#1\hfill Phrasenschema~\arabic{deskgram-strsch}}{
    \centering
    #2
  }
}
...
\newcommand{\WeitereLiteratur}[1]{
  \tblslinebox{lsLightGray}{Weiterführende Literatur zu \thepart}{#1}
}
...
\tikzset{
  ...
  Ephr/.style={fill=gray, inner sep=3pt,
    delay={content=\whyte{##1}}},
  Eobl/.style={draw, inner sep=3pt},
  Eopt/.style={draw, densely dashed, inner sep=3pt},
  Erec/.style={draw, double, inner sep=3pt},
  Eoptrec/.style={draw, densely dashed, double, inner sep=3pt},
  Ehd/.style={fill=gray, inner sep=3pt,
    delay={content=\whyte{##1}}
  },
  Emult/.style={for children={no edge}, for tree={l sep=0pt}},
  phrasenschema/.style={for tree={l sep=2em, s sep=2em}},
  decide/.style={draw, rectangle, inner sep=5pt},
  finall/.style={rounded corners, fill=lsLightGray, text=black},
