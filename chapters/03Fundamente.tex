...
In (\ref{ex:paradigmaundsyntagma010}) liegt ein Nebensatz mit \textit{dass} vor (vgl.\ Abschnitt~\ref{sec:ergaenzungssaetze}), in (\ref{ex:paradigmaundsyntagma011}) eine Infinitivkonstruktion (vgl.\ Abschnitt~\ref{sec:infinitivkontrolle}).\index{Nebensatz}\index{Infinitiv}
...
Aus den Eigenschaften in Tabelle~\ref{tab:valenz075} müssen wir jetzt definitorisch hinreichende auswählen.
