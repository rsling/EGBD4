...
\begin{exe}
  ...
  \begin{xlist}
    \ex{\label{ex:erweiterteflexibilitaetderkoordination002} Konjunktionen stellen eine Verbindung [[von zwei Wortformen] oder [zweier Phrasen]] her.}
...
\begin{exe}
  ...
  \begin{xlist}
    \ex{\label{ex:adjektivphrase088} die [[seit dem Vortag] sehr angenehme] Stimmung}
    \ex{\label{ex:adjektivphrase089} das [[in Hessen] überaus beliebte] Getränk}
  \end{xlist}
  \ex[*]{\label{ex:adjektivphrase090}die [sehr [seit dem Vortag] angenehme] Stimmung}
\end{exe}
...
\begin{figure}[!htbp]
  ...
  \begin{forest}
    [AP
      [PP
        [\it auf ihre Tochter, narroof, name=AufIhreTochter, tt]
      ]
      [\bf A
        [\it stolze, tt]
...
Einen Modifizierer in Form einer AP (\textit{weit}) wird in (\ref{ex:normalepp097}) gezeigt.
