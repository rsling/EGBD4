...
Zum Bereich des \textit{Explizierens}, also dem Verständlichmachen von komplexen Sachverhalten, zählt er komplexe Adverbiale (Angaben des Verbs), Attribute und explizite Satzverbindung (\zB kausal oder adversativ).
...
Dort werden die entsprechenden Sätze ohne besondere Markierungen aber trotzdem ähnlich verwendet, oder es kommen andere Markierung wie zum Beispiel Angaben oder besondere Konstituentenstellungen zum Zug.
