...
\begin{table}[!htbp]
  \resizebox{\textwidth}{!}{
    \begin{tabular}{lll}
      ...
      \midrule
      Nomen (Substantiv, Pronomen) & Nominalphrase (NP) & \textit{die tolle \textbf{Auf"|führung}} \\
      Adjektiv & Adjektivphrase (AP) & \textit{sehr \textbf{schön}} \\
      Präposition & Präpositionalphrase (PP) & \textit{\textbf{in} der Uni} \\
      Adverb & Adverbphrase (AvP) & \textit{total \textbf{offensichtlich}} \\
      Verb & Verbphrase (VP) & \textit{Sarah den Kuchen gebacken \textbf{hat}} \\
      Subjunktion & Subjunktionsphrase (SP) & \textit{\textbf{dass} es läuft} \\
      \lspbottomrule
    \end{tabular}
  }
