...
Wie in Abschnitt~\ref{sec:ergaenzungssaetze} ausführlich diskutiert wird, gibt es auch Subjekte, die nicht nominal, sondern satzförmig oder nebensatzförmig sind.
...
In (\ref{ex:personundnumerus001}) ist das Subjekt ein Nebensatz, der mit \textit{dass} eingeleitet wird (ein Ergänzungssatz bzw.\ genauer ein Subjektsatz).
...
Durch Hinzufügen von vergangenheitsbezogenen Angaben wie \textit{gestern}, \textit{letzte Woche} usw.\ kann der Zeitpunkt eindeutiger eingegrenzt werden.
Selbst wenn gegenwartsbezogene Angaben wie \textit{heute} hinzugefügt werden, geben diese Angaben zwar einen zeitlichen Rahmen vor, aber das Ereignis bleibt innerhalb des Rahmens in der Vergangenheit lokalisiert.
...
Die Referenzzeit wird in (\ref{ex:tempus021}) mit der Angabe \textit{spätestens nächste Woche} spezifiziert, das Ereignis ist in der Interpretation von (\ref{ex:tempus021}) das Fassen des Mörders.
...
In (\ref{ex:tempus019}) liefern Angaben die Referenzzeitpunkte, es kann aber genausogut der Kontext (\ref{ex:tempus027}) oder die Äußerungssituation sein.
