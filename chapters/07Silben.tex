...
\begin{exe}
  ...
  \begin{xlist}
    \ex{\label{ex:derendrandimeinsilbler071} Lump, Amt}
...
Sonst wäre ein Einsilbler wie \textit{ahnt} mit [ʔaːnt] bereits viermorig und damit zu schwer, Wörter wie \textit{ahnst} [ʔaːnst] mit (hypothetisch) fünf Moren erst recht.
...
Kreisen Sie alle extrasilbischen Segmente ein.
Markieren Sie dabei in mehrsilbigen Wörtern die Silbengrenzen und Silbengelenke eindeutig dadurch, dass Sie den Silbenkontur"=Strich an der Silbengrenze absetzen oder das im Silbengelenk stehendes Segment in eine Raute setzen.
